  ...
  return (
    <div className="max-w-7xl w-full flex flex-col md:flex-row md:justify-between p-4">
      <div className="flex flex-col">
        <h2 className="md:mt-16 font-Baloo text-2xl md:text-4xl font-extrabold text-yellow-dark">
        ...
        <div className="flex w-full md:w-[80%] md:pl-8 p-5 md:pr-24 py-8 flex-col items-start gap-8 mt-8 rounded-tr-3xl rounded-bl-3xl rounded-md border border-purple">
          <div className="flex items-center gap-3">
            ...
            <p>
              {" "}
              Entrega em:{" "}
              <strong>{`${deliveryData.endereco.rua}, ${deliveryData.endereco.numero}`}</strong>
            </p>
          </div>
          <div className="flex items-center gap-3">
            ...
            <p>{`${deliveryData.endereco.bairro} - ${deliveryData.endereco.cidade}, ${deliveryData.endereco.uf}`}</p>
          </div>
          <div className="flex items-center gap-3">
            ...
            <p>
              Pagamento:{" "}
              <strong>{deliveryData.metodoPagamento || "Não informado"}</strong>
            </p>
          </div>
        </div>
      </div>
