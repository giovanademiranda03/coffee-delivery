    ...
    <div className="flex flex-col w-[68] h-80 justify-center items-center rounded-tr-3xl rounded-bl-3xl rounded-sm bg-card p-5">
      ...
      <div className="flex flex-col w-full mb-1 items-center relative -top-5">
        <div className="flex gap-2 mb-4">
          {product.tags.map((tag, product) => (
            <p
              className="flex justify-center items-center py-1 px-2 text-yellow-dark font-bold text-xs rounded-full bg-yellow-light"
              key={product}
            >
              {tag.toUpperCase()}
            </p>
        ...
        <h3 className="text-subtitle text-center font-Baloo text-lg font-bold leading-7 mb-1">
          {product.title}
        </h3>
        <p className="text-label text-center text-sm leading-7">
          {product.description}
        </p>
      </div>
      <div className="w-full flex justify-between">
        <div className="flex font-Baloo text-2xl font-bold leading-6 text-text">
          <span className="flex justify-center items-center">
            ...
            <h3 className="font-Baloo text-2xl text-text leading-6 font-extrabold">
        ...
        <div className="flex gap-2">
          ...
          <button
            data-cy="add-cart"
            className="flex p-2 justify-center items-center gap-2 rounded-md bg-purple-dark hover:bg-purple border-0"
            type="submit"
            onClick={addToCart}
          >
