...
export default function MethodPayment() {
  const { setDeliveryData } = useDeliveryContext();

  const handlePaymentMethod = (method: string) => {
    setDeliveryData({ metodoPagamento: method });
  };
      ...
      <div className="w-full flex flex-col bg-card p-5 md:p-10 rounded-lg">
        ...
        <div className="w-full flex flex-col md:flex-row gap-4">
          <button
            type="submit"
            data-cy="credito"
            className="md:w-[33%] flex flex-row p-4 items-center gap-2 hover:bg-purple-light border-2 focus:bg-purple-light focus:border-purple bg-button rounded-lg"
          ...
          <button
            type="submit"
            data-cy="debito"
            className="md:w-[33%] flex flex-row p-4 gap-2 items-center justify-start hover:bg-purple-light border-2 focus:bg-purple-light focus:border-purple  bg-button rounded-lg"
